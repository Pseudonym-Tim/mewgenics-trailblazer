...
// Dedicated unset marker. Packed tile 0 is the legitimate board coordinate (0,0)...
// (This value decodes far outside the plausible board range and cannot collide with a valid tile)...
#define INVALID_TILE UINT64_C(0x8000000080000000)
